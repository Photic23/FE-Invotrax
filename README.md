...
## Cara pake appnya
cd ke fe-invotrax terus baca readme di situ yak
...
```
cd existing_repo
git remote add origin https://gitlab.cs.ui.ac.id/propensi-2024-2025-genap/kelas-a/a06-propenchill-fe.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.cs.ui.ac.id/propensi-2024-2025-genap/kelas-a/a06-propenchill-fe/-/settings/integrations)
